    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='text-blue-400 bg-gray-50'>{userData.email}</p>
          <p className='font-medium'>Phone:</p>
          {
            isEdit
              ...
              : <p className='text-blue-400 bg-gray-50'>{userData.phone}</p>
          }
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          <p className='font-medium'>Gender:</p>
          {
            isEdit
              ...
              : <p className='text-gray-400 bg-gray-50'>{userData.gender}</p>
          }
          <p className='font-medium'>Birthday:</p>
          {
            ...
            : <p className='text-gray-400 bg-gray-50'>{userData.dob}</p>
          }
        </div>
      </div>
